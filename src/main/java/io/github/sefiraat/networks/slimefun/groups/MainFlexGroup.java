...
public class MainFlexGroup extends FlexItemGroup {
    ...
    private static final SlimefunItemStack DOCS_ITEM_STACK = Theme.themedItemStack(
            Material.BOOK,
            Theme.GUIDE,
            "Documentation Wiki",
    ...
    public MainFlexGroup(NamespacedKey key, SlimefunItemStack item) {
        super(key, item.item());
    }
    ...
    private void setupPage(Player player, PlayerProfile profile, SlimefunGuideMode mode, ChestMenu menu) {
        ...
        // Docs
        menu.replaceExistingItem(DOCS, DOCS_ITEM_STACK.item());
