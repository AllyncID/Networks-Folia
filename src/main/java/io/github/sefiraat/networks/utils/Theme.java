...
public enum Theme {
    ...
    public Particle.DustOptions getDustOptions(float size) {
        ...
        if (name.startsWith("#")) {
            awtColor = java.awt.Color.decode(name);
        } else {
            // Manual mapping for legacy colors
            switch (name) {
                case "black": awtColor = new java.awt.Color(0, 0, 0); break;
                case "dark_blue": awtColor = new java.awt.Color(0, 0, 170); break;
                case "dark_green": awtColor = new java.awt.Color(0, 170, 0); break;
                case "dark_aqua": awtColor = new java.awt.Color(0, 170, 170); break;
                case "dark_red": awtColor = new java.awt.Color(170, 0, 0); break;
                case "dark_purple": awtColor = new java.awt.Color(170, 0, 170); break;
                case "gold": awtColor = new java.awt.Color(255, 170, 0); break;
                case "gray": awtColor = new java.awt.Color(170, 170, 170); break;
                case "dark_gray": awtColor = new java.awt.Color(85, 85, 85); break;
                case "blue": awtColor = new java.awt.Color(85, 85, 255); break;
                case "green": awtColor = new java.awt.Color(85, 255, 85); break;
                case "aqua": awtColor = new java.awt.Color(85, 255, 255); break;
                case "red": awtColor = new java.awt.Color(255, 85, 85); break;
                case "light_purple": awtColor = new java.awt.Color(255, 85, 255); break;
                case "yellow": awtColor = new java.awt.Color(255, 255, 85); break;
                case "white": awtColor = new java.awt.Color(255, 255, 255); break;
                default: awtColor = new java.awt.Color(255, 255, 255); break; // fallback
            }
        }
    ...
    @Nonnull
    @ParametersAreNonnullByDefault
    public static SlimefunItemStack themedItemStack(Material material, Theme themeType, String name, String... lore) {
        ChatColor passiveColor = Theme.PASSIVE.getColor();
        List<String> finalLore = new ArrayList<>();
        finalLore.add("");
        for (String s : lore) {
        ...
        finalLore.add(applyThemeToString(Theme.CLICK_INFO, themeType.getLoreLine()));
        return new SlimefunItemStack(
                "NTW_THEMED_" + name.toUpperCase().replace(" ", "_"),
                material,
                Theme.applyThemeToString(themeType, name),
                finalLore.toArray(new String[0])
        );
